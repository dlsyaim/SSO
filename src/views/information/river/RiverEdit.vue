              ...
              <a-col span="8">
                <a-form-item v-bind="formLayout" label="河流类型">
                  <a-select v-decorator="['riverType']" placeholder="请选择河流类型">
                    <a-select-option v-for="item in riverTypeList" :key="item.id" :value="item.typeValue">{{item.typeName}}
                    </a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="8">
                <a-form-item v-bind="formLayout" label="河流功能">
                  <a-select v-decorator="['feature']" placeholder="请选择河流功能">
                    <a-select-option v-for="item in riverFunctionList" :key="item.id" :value="item.typeValue">
                      {{item.typeName}}
                    </a-select-option>
                  </a-select>
                </a-form-item>
