    ...
    <a-card title="河长巡河台账" :bordered="false" style="min-height: 100%">
      <div style="display: flex;align-items: center;justify-content: space-between">
        <div style="display: flex;align-items: center">
          <span>行政区域：</span>
          <a-input style="cursor: pointer;margin-right: 40px;width: 240px;" placeholder="请选择行政区域" readOnly :value="region.name" @click="visible=true"></a-input>
      ...
      <div style="margin-top: 18px;">
        <a-table :columns="columns"
          ...
          <span data-method="download" :data-id="item.id" class="table-operation">{{item.chairman_name}}</span>
          </span>
...
<script>
  ...
  const columns = [
    ...
    {title: '河长姓名', key: 'riverChiefName', scopedSlots: {customRender: 'riverChiefName'}, width: 100},
